import styles from './homeMainContent.css';
export default function HomeMainContent() {
  return (
    <div className="flex flex-col justify-between px-5">
      <div className={`animate-moveAndFade duration-1000 ${styles.moveAndFade} flex justify-end text-right`}>
        <h4 className="w-[50%]">
      ...
      <div className={`max-w-2xl animate-moveAndFade duration-1000 ${styles.moveAndFade}`}>
        <h4>
